  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white font-sans antialiased">
      ...
      <section className="relative min-h-screen flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-white/60 max-w-2xl mb-10 leading-relaxed">
            ...
            Age-aware protection: a 7-year-old gets strict blocking, a 14-year-old gets more
            freedom. All controlled from your phone.
          </p>
        ...
        <a
          href="#how"
          className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-white/40 hover:text-white/60 transition cursor-pointer"
        >
          <svg
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-[#0A0A0F] to-[#12141C]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-xs uppercase tracking-[0.3em] text-[#FFC72C] mb-4 block">
              The Problem
            </span>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Every parental control fails.
              <br />
      ...
      <section className="py-24 px-6 bg-[#12141C]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-xs uppercase tracking-[0.3em] text-[#C7FF4D] mb-4 block">
              The Nemyo Approach
            </span>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Don&apos;t filter the internet.
              <br />
              <span className="text-[#C7FF4D]">Replace it.</span>
            </h2>
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              Instead of trying to block bad content (which never works), Nemyo blocks the apps
              themselves and provides a curated alternative.
            </p>
          </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-red-400 text-sm block">
                      Tries to filter results → Kids use VPN
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-red-400 text-sm block">
                      Restricted Mode → Easily bypassed
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-red-400 text-sm block">
                      Site blocks → They use another browser
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-[#C7FF4D] text-sm block">
                      Completely blocked from network
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-[#C7FF4D] text-sm block">
                      Curated YouTube Kids, PBS, Khan Academy
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-[#C7FF4D] text-sm block">
                      Only what you allow can connect
                    </span>
                  </div>
                </div>
              </div>
      ...
      <section id="how" className="py-24 px-6 bg-[#0A0A0F]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-xs uppercase tracking-[0.3em] text-[#A979F2] mb-4 block">
              How it works
            </span>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Three steps to a safer phone</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-white/60 mb-8 leading-relaxed">
                Explore isn&apos;t a browser—it&apos;s a curated discovery space. Kids tap into
                categories like Learn, Watch, Create, and Play. Each destination is hand-picked for
                safety and quality.
              </p>
      ...
      <section className="py-24 px-6 bg-[#12141C]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6">What Nemyo blocks</h2>
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              These apps can&apos;t connect to the internet while Nemyo Shield is active. No
              workarounds. No exceptions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="p-4 bg-white/5 border border-red-500/20 rounded-xl text-center"
              >
          ...
          <div className="mt-12 p-6 bg-[#C7FF4D]/10 border border-[#C7FF4D]/30 rounded-2xl text-center">
            <p className="text-lg">
              ...
              <span className="text-white/80">
                Toggle any app on/off from your parent app. Allow YouTube for your 12-year-old but
                not your 7-year-old. WhatsApp and family apps always work.
              </span>
            </p>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-[#0A0A0F]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Protection without surveillance</h2>
          <p className="text-lg text-white/60 mb-12 max-w-2xl mx-auto">
            Nemyo is protection, not spyware. We don&apos;t track browsing history, read messages,
            or monitor activity. We simply block dangerous apps and provide safe alternatives.
          </p>
      ...
      <section id="pricing" className="py-24 px-6 bg-gradient-to-b from-[#0A0A0F] to-[#12141C]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6">Simple, fair pricing</h2>
          <p className="text-lg text-white/60 mb-12">Protect up to 5 devices. Cancel anytime.</p>
      ...
      <section className="py-24 px-6 bg-[#12141C]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to stop worrying?</h2>
          <p className="text-lg text-white/60 mb-10 max-w-xl mx-auto">
            Join thousands of parents who finally have peace of mind. Control everything from your
            phone. See when their device is online. No more arguments about screen time. Just a
            safe, calm digital space.
          </p>
